...
const Vote = () => {
  ...
  const votingEndDate = new Date("2024-11-07T16:00:00Z");
        ...
        {isVotingOpen ? (
          ...
          <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex justify-center items-center">
            <div className="bg-white p-6 rounded shadow-lg text-center">
              ...
              <p className="text-gray-600">The voting period is from November 1st at 20:00:00Z to November 8, 2024, 23:59:59Z.</p>
